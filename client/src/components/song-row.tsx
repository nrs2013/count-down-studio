  ...
  return (
    ...
    >
      ...
      {showMidiColumn && (
        ...
        >
          <option value="" style={{ background: "#0a0a0a", color: "rgba(255,255,255,0.5)" }}>No MIDI</option>
          {MIDI_NOTES_BY_NAME.map((group) => (
            <optgroup key={group.noteName} label={`── ${group.noteName} ──`} style={{ background: "#141312", color: "rgba(255,255,255,0.5)", fontWeight: 700 }}>
              {group.notes.map((n) => (
                <option key={n.value} value={String(n.value)} style={{ background: "#0a0a0a", color: "rgba(255,255,255,0.9)", fontWeight: 400 }}>
                  {n.label}
                </option>
              ))}
            </optgroup>
  ...
  return (
    ...
    >
      ...
      <button
        ...
        style={{
          color: "#fafaf8",
          background: "rgba(245,168,40,0.15)",
          border: "0.5px solid #f5a828",
          boxShadow: "none",
        }}
      ...
      {onAddEncore && (
        <button
          ...
          style={{
            color: "#fafaf8",
            background: "rgba(126,216,72,0.15)",
            border: "0.5px solid #7ed848",
            boxShadow: "none",
          }}
      ...
      {onAddEnd && (
        <button
          ...
          style={{
            color: "#fafaf8",
            background: "rgba(255,212,68,0.15)",
            border: "0.5px solid #ffd444",
            boxShadow: "none",
          }}
