  ...
  return (
    <div
      ...
      style={{
        ...
        background: isCurrent ? "#2a1e28" : "#2a231e",
        borderRadius: "10px",
        marginBottom: "3px",
        border: isCurrent ? "1px solid #c186c8" : "1px solid #322a24",
        boxShadow: isCurrent
    ...
    >
      ...
      {showPlayButton && (
        <button
          ...
          style={{
            ...
            background: isCurrent ? "#c186c8" : "#322a24",
            border: "none",
          }}
      ...
      {showMidiColumn && (
        ...
        >
          <option value="" style={{ background: "#181411", color: "rgba(255,255,255,0.5)" }}>No MIDI</option>
          {MIDI_NOTES_BY_NAME.map((group) => (
            <optgroup key={group.noteName} label={`── ${group.noteName} ──`} style={{ background: "#1e1814", color: "rgba(255,255,255,0.5)", fontWeight: 700 }}>
              {group.notes.map((n) => (
                <option key={n.value} value={String(n.value)} style={{ background: "#181411", color: "rgba(255,255,255,0.9)", fontWeight: 400 }}>
                  {n.label}
                </option>
              ))}
            </optgroup>
      ...
      <button
        ...
        onMouseEnter={(e) => { e.currentTarget.style.color = "#a8a8a0"; e.currentTarget.style.background = "#1e1814"; }}
