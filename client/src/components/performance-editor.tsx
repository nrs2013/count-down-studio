    ...
    >
      ...
      <button
        ...
        style={{
          ...
          background: enabled ? "rgba(193,134,200,0.14)" : "#141312",
  ...
  return (
    <div className="flex flex-col h-full w-full" style={{
      ...
      >
        <div className="flex items-end gap-3">
          <button
            ...
            style={{
              background: showingEventInfo ? "#c186c8" : "#141312",
          ...
          <input
            ...
            style={{ background: "#141312", border: "1px solid #2c2a27", color: "#e8e8e2", fontFamily: UI_FONT }}
          ...
          <div className="flex flex-col items-center shrink-0" style={{ width: "88px" }}>
            ...
            <input
              ...
              style={{ background: "#141312", border: "1px solid #2c2a27", color: "#e8e8e2", fontFamily: MONO_FONT }}
      ...
      {/* LEFT: External display preview area.
          Outer container is WARM GRAY (#0a0a0a). ONLY the 16:9 preview rectangle is pure BLACK.
      ...
      >
        ...
        <div className="shrink-0" style={{ height: 40, background: "#0a0a0a" }} />

        {/* 16:9 preview rectangle — ONLY this is pure black, capped so it never overflows */}
        <div className="px-6 w-full shrink-0" style={{ background: "#0a0a0a" }}>
          <div
              ...
              return (
                <button
                  ...
                  style={{
                    ...
                    borderRadius: 4,
                    padding: "5px 12px",
                    fontFamily: "'Bebas Neue', 'Noto Sans JP', Impact, sans-serif",
                    fontWeight: 900,
                    fontSize: 14,
        ...
        >
          ...
          {countdownStatus === "paused" ? (
            <button onClick={onResume} className={ctrlBtnClass}
              style={{ color: "#e8e8e2", background: "#141312", border: "1px solid #2c2a27" }}
        ...
        <div className="flex-1 min-h-[16px]" style={{ background: "#0a0a0a" }} />
      </div>
      ...
      >
        ...
        <div ref={editorScrollRef} className="flex-1 overflow-y-scroll min-h-0">
          <div className="sticky top-0 z-20" style={{ background: "#0a0a0a" }}>
