            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16, marginBottom: 14 }}>
              <div>
                ...
                <input
                  ...
                  style={{ width: "100%", background: "#1d1b19", border: "0.5px solid #2c2a27", color: "#e8e5dc", padding: "7px 10px", borderRadius: 4, fontSize: 14, fontFamily: "'Bebas Neue', 'Noto Sans JP', Impact, sans-serif", letterSpacing: "0.02em", boxSizing: "border-box" }}
                />
