          ...
          {cues.map((cue) => {
            ...
            return (
              <div
                ...
                style={{
                  background: editing ? "#2a2622" : "#1c1b19",
              ...
              >
                ...
                <div style={{ display: "flex", justifyContent: "space-between", marginTop: 6, fontSize: 10 }}>
                  ...
                  <span style={{ background: "#14130f", border: "0.5px solid #2c2a27", padding: "1px 6px", borderRadius: 3, fontFamily: "JetBrains Mono, monospace", color: "#e8e5dc" }}>{displayKey(cue.shortcutKey)}</span>
                </div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16, marginBottom: 14 }}>
              <div>
                ...
                <input
                  ...
                  style={{ width: "100%", background: "#14130f", border: "0.5px solid #2c2a27", color: "#e8e5dc", padding: "7px 10px", borderRadius: 4, fontSize: 14, fontFamily: "'Bebas Neue', 'Noto Sans JP', Impact, sans-serif", letterSpacing: "0.02em", boxSizing: "border-box" }}
                />
              ...
              <div>
                ...
                <div style={{ display: "flex", gap: 6, alignItems: "center" }}>
                  <div style={{ flex: 1, background: "#14130f", border: "0.5px solid #2c2a27", color: "#e8e5dc", padding: "7px 10px", borderRadius: 4, fontSize: 13 }}>
              ...
              <div style={{ display: "flex", gap: 6, flexWrap: "wrap", alignItems: "center" }}>
                ...
                <div style={{ display: "inline-flex", alignItems: "center", gap: 4, marginLeft: 6 }}>
                  ...
                  <input
                    ...
                    style={{ width: 80, background: "#14130f", border: "0.5px solid #2c2a27", color: "#e8e5dc", padding: "4px 8px", borderRadius: 4, fontSize: 11, fontFamily: "JetBrains Mono, monospace" }}
                  />
                </div>
              </div>
            </div>
              ...
              <div style={{ display: "flex", gap: 6, flexWrap: "wrap", alignItems: "center" }}>
                ...
                <button
                  ...
                  style={{
                    ...
                    background: !draft.textColor ? "#c186c8" : "#14130f",
            ...
            <div style={{ marginBottom: 14 }}>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                <button
                  ...
                  title="Smaller"
                  style={{ width: 38, height: 32, background: "#14130f", border: "0.5px solid #2c2a27", color: "#e8e5dc", borderRadius: 4, fontSize: 16, cursor: "pointer", fontFamily: "JetBrains Mono, monospace" }}
                >−</button>
                <div style={{ flex: 1, background: "#14130f", border: "0.5px solid #2c2a27", borderRadius: 4, padding: "7px 12px", fontSize: 12, color: "#e8e5dc", textAlign: "center", fontFamily: "JetBrains Mono, monospace" }}>
                  {(() => {
...
function blinkBtnStyle(active: boolean): React.CSSProperties {
  return {
    flex: 1,
    background: active ? "#c186c8" : "#14130f",
